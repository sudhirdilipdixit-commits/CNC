...
const COURSE_HEADERS = "internalName,courseName,universityName,duration,fees,eligibility,badge,isFeatured,logoUrl,logoAlt,logoTitle,logoDescription";
const COURSE_SAMPLE = `Amity Online MBA Marketing 2026,Online MBA in Marketing Management,Amity University Online,2 Years,"Rs 80,000 - Rs 1,20,000",Graduation in any stream | Min. 50%,Top Pick,TRUE,https://example.com/logo.png,Amity University Online logo,Amity University Online,Online MBA programmes from Amity University`;

const UNIVERSITY_HEADERS = "internalName,universityName,duration,approvedBy,fees,eligibility,badge,isFeatured,logoUrl,logoAlt,logoTitle,logoDescription";
const UNIVERSITY_SAMPLE = `Amity Online MBA 2026,Amity University Online,2 Years,UGC-DEB|NAAC A++,"Rs 1,20,000/year",Graduation in any stream | Min. 50%,NAAC A++,TRUE,https://example.com/logo.png,Amity University Online logo,Amity University Online,UGC-DEB approved online MBA university`;
