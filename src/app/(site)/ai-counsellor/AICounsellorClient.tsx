...
import type { SanityProgramme } from "./page";
...
// ─── Fallback data (used if no courseCards have AI fields set in Sanity) ──────
const FALLBACK_PROGRAMMES: Programme[] = [
  { id: "hc-1",  name: "Online MBA in Marketing",       uni: "Symbiosis Centre for Distance Learning", mode: "online",    duration: "24 months", feeDisplay: "₹1.8 L",  feeBand: "1-2",   batch: "Mar 2026",   accreditations: ["UGC-DEB", "AICTE", "NAAC A++"], specs: ["marketing"],                    profiles: ["working_professional", "graduate"],              timeBands: ["manageable", "committed", "intensive"],   goals: ["promotion", "switch", "salary"] },
  { id: "hc-2",  name: "Distance MBA in HR",             uni: "NMIMS Global Access",                   mode: "distance",  duration: "24 months", feeDisplay: "₹1.5 L",  feeBand: "1-2",   batch: "Apr 2026",   accreditations: ["UGC-DEB", "AICTE"],              specs: ["hr"],                           profiles: ["working_professional", "graduate"],              timeBands: ["very_limited", "manageable", "committed"], goals: ["promotion", "switch"] },
  { id: "hc-3",  name: "Executive Online MBA",           uni: "IIM Indore",                            mode: "executive", duration: "12 months", feeDisplay: "₹6.5 L",  feeBand: "5plus", batch: "Jul 2026",   accreditations: ["UGC-DEB", "AICTE", "NAAC A++"], specs: ["general", "marketing", "finance"],profiles: ["entrepreneur", "working_professional"],          timeBands: ["intensive", "committed"],                  goals: ["promotion", "business"] },
  { id: "hc-4",  name: "Online MBA in Finance",          uni: "Amity University Online",               mode: "online",    duration: "24 months", feeDisplay: "₹1.5 L",  feeBand: "1-2",   batch: "Quarterly",  accreditations: ["UGC-DEB", "NAAC A+"],            specs: ["finance"],                      profiles: ["working_professional", "graduate"],              timeBands: ["manageable", "committed"],                 goals: ["promotion", "switch", "salary"] },
  { id: "hc-5",  name: "Online MBA in IT & PM",          uni: "Manipal Online Education",              mode: "online",    duration: "24 months", feeDisplay: "₹1.4 L",  feeBand: "1-2",   batch: "Quarterly",  accreditations: ["UGC-DEB", "NAAC A+"],            specs: ["it"],                           profiles: ["working_professional"],                         timeBands: ["manageable", "committed", "intensive"],   goals: ["promotion", "switch", "salary"] },
  { id: "hc-6",  name: "Online MBA in Healthcare",       uni: "Symbiosis Centre for Distance Learning", mode: "online",   duration: "24 months", feeDisplay: "₹2.1 L",  feeBand: "2-5",   batch: "Sep 2026",   accreditations: ["UGC-DEB", "NAAC A++"],           specs: ["healthcare"],                   profiles: ["working_professional", "graduate"],              timeBands: ["manageable", "committed"],                 goals: ["promotion", "switch"] },
  { id: "hc-7",  name: "Distance MBA in Finance",        uni: "ICFAI University",                      mode: "distance",  duration: "24 months", feeDisplay: "₹0.9 L",  feeBand: "u1",    batch: "Jul 2026",   accreditations: ["UGC-DEB"],                       specs: ["finance"],                      profiles: ["graduate", "career_break"],                     timeBands: ["very_limited", "manageable"],              goals: ["salary"] },
  { id: "hc-8",  name: "Distance MBA in Operations",     uni: "Welingkar Distance Learning",           mode: "distance",  duration: "24 months", feeDisplay: "₹1.1 L",  feeBand: "1-2",   batch: "Jun 2026",   accreditations: ["UGC-DEB"],                       specs: ["operations"],                   profiles: ["working_professional", "graduate"],              timeBands: ["very_limited", "manageable"],              goals: ["promotion", "salary"] },
  { id: "hc-9",  name: "Online MBA in Digital Marketing", uni: "OP Jindal Global University",          mode: "online",    duration: "18 months", feeDisplay: "₹2.8 L",  feeBand: "2-5",   batch: "May 2026",   accreditations: ["UGC-DEB", "NAAC A"],             specs: ["marketing"],                    profiles: ["working_professional", "entrepreneur"],          timeBands: ["committed", "intensive"],                  goals: ["switch", "business", "salary"] },
  { id: "hc-10", name: "EPGP Executive MBA",             uni: "IIM Kozhikode",                         mode: "executive", duration: "12 months", feeDisplay: "₹7 L",    feeBand: "5plus", batch: "Aug 2026",   accreditations: ["UGC-DEB", "AICTE", "NAAC A++"], specs: ["general"],                      profiles: ["working_professional", "entrepreneur"],          timeBands: ["intensive"],                               goals: ["promotion", "business"] },
  { id: "hc-11", name: "Online MBA in HR",               uni: "Amity University Online",               mode: "online",    duration: "24 months", feeDisplay: "₹1.5 L",  feeBand: "1-2",   batch: "Quarterly",  accreditations: ["UGC-DEB", "NAAC A+"],            specs: ["hr"],                           profiles: ["working_professional", "graduate", "career_break"], timeBands: ["manageable", "committed"],              goals: ["promotion", "switch"] },
  { id: "hc-12", name: "Online MBA in Marketing",        uni: "Manipal Online Education",              mode: "online",    duration: "24 months", feeDisplay: "₹1.4 L",  feeBand: "1-2",   batch: "Quarterly",  accreditations: ["UGC-DEB", "NAAC A+"],            specs: ["marketing"],                    profiles: ["working_professional", "graduate"],              timeBands: ["manageable", "committed"],                 goals: ["promotion", "switch", "salary"] },
];

// ─── Sanity → internal mapper ─────────────────────────────────────────────────
function mapSanityToProgramme(sp: SanityProgramme): Programme {
  return {
    id: sp._id,
    name: sp.courseName,
...
// ─── Component ────────────────────────────────────────────────────────────────
export default function AICounsellorClient({ sanityProgrammes }: { sanityProgrammes: SanityProgramme[] }) {
  // Use Sanity data when available; fall back to hardcoded seed data
  const programmes: Programme[] = sanityProgrammes.length > 0
    ? sanityProgrammes.map(mapSanityToProgramme)
    : FALLBACK_PROGRAMMES;
  ...
  function computeResults(ans: Answers) {
    ...
    setTimeout(() => {
      ...
      // Primary sort: score desc. Ties broken by original array order (Sanity returns featured-first).
    ...
    <>
      ...
      {view === "wizard" && qData && (
        <div style={{ background: "var(--ivory)", minHeight: "70vh", paddingBottom: 80 }}>
          ...
          {/* key forces remount → re-triggers fadeInUp */}
