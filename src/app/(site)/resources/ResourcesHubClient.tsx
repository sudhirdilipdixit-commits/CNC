...
const SEED_RESOURCES: ResourceItem[] = [
  {
    ...
    slug: "top-10-online-mba-programmes-india-2026-27",
  ...
  },
  {
    ...
    slug: "distance-mba-vs-online-mba",
  ...
  },
  {
    ...
    slug: "returning-after-career-break-2026",
      ...
      <section style={{ background: "var(--yellow)", padding: "56px 0", textAlign: "center", borderTop: "4px solid var(--navy)" }}>
        <div className="container" style={{ maxWidth: 680 }}>
          ...
          <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
            ...
            <a href="/ai-counsellor" className="btn btn-secondary">
              Try AI Counsellor
            </a>
          </div>
        </div>
