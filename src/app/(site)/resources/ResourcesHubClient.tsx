...
const SEED_RESOURCES: ResourceItem[] = [
  ...
  },
  {
    ...
    checklistItems: [
      "Monthly EMI for a bank loan, with indicative SBI, HDFC, ICICI starting rates",
      "University direct (interest-free) EMI plan compared side by side",
      "Total interest and total repayment over the full tenure",
      "Recalculates instantly as you change the amount, rate, or tenure",
    ],
