        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              ...
              { "@type": "Question", name: "How does CollegeNCourses help me plan my MBA fees and financing?", acceptedAnswer: { "@type": "Answer", text: "Our AI Counsellor walks through the full 6-step true-cost calculation, helps identify applicable scholarships and Section 80E tax benefits specific to your situation, and cross-checks the university's fee structure for hidden costs or red flags before you enrol. Free, no call required." } },
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "A 6-step worksheet used by CollegeNCourses to calculate the genuine all-in cost of a Distance, Online, or Executive MBA, including hidden fees and net financing cost.",
            step: [
