        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              ...
              { "@type": "Question", name: "How does CollegeNCourses help verify government job eligibility?", acceptedAnswer: { "@type": "Answer", text: "Our team helps you check UGC-DEB approval status, read and interpret specific job notifications, and where useful, draft the written clarification request. Free, no call required. We do not guarantee outcomes for any specific job posting." } },
            ],
          }),
        }}
      />
