...
const FAQS: FAQ[] = [
  ...
  { q: "How does CollegeNCourses help me choose a PM MBA?", a: `We match you to programmes based on your target industry (IT, construction, consulting, or product), certification plan (PMP, Scrum), consulting reset aspirations, budget, and timeline. Free, no call required. No paid referral affects our recommendation.` },
    ...
    <>
      ...
      <section className="pm-cta-band">
        <div className="pm-wrap">
          ...
          <p>Get a free shortlist from our AI Counsellor. We&apos;ll match you to three programmes based on your target industry (IT, construction, consulting, or product), certification plan (PMP, Scrum), consulting reset aspirations, budget, and timeline. Free, no call required.</p>
