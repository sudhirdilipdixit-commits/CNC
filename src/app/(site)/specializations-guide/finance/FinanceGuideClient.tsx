...
const FAQS: FAQ[] = [
  ...
  { q: "How does CollegeNCourses help me choose a Finance MBA?", a: `We match you to programmes based on your target function (FP&A vs consulting vs IB vs CFO track), existing credentials (CA, CFA, engineering), budget, and timeline. Free, no call required. No paid referral affects our recommendation.` },
  ...
  return (
    <>
      <style>{`
        ...
        .fm-h1{font-family:var(--font-serif);font-size:clamp(1.7rem,4vw,2.5rem);line-height:1.2;font-weight:700;text-wrap:balance;margin-bottom:1rem;color:#fff}
      ...
      <section className="fm-cta-band">
        <div className="fm-wrap">
          ...
          <p>Get a free shortlist from our AI Counsellor. We&apos;ll match you to three programmes based on your target function, existing credentials (CA, CFA, engineering), budget, and timeline. Free, no call required.</p>
