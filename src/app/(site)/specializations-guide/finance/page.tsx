        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              ...
              { "@type": "Question", name: "How does CollegeNCourses help me choose a Finance MBA?", acceptedAnswer: { "@type": "Answer", text: "We match you to programmes based on your target function (FP&A vs consulting vs IB vs CFO track), existing credentials (CA, CFA, engineering), budget, and timeline. Free, no call required." } },
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "A 5-question framework used by CollegeNCourses to help aspirants choose a Finance Management MBA in 2025-26.",
            step: [
