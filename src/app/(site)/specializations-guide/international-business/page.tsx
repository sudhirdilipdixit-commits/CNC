        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              ...
              { "@type": "Question", name: "How does CollegeNCourses help me choose an International Business MBA?", acceptedAnswer: { "@type": "Answer", text: "We match you to programmes based on your target role type (MNC, export-import, family business), current experience, comfort with international travel, budget, and timeline. Free, no call required. No paid referral affects our recommendation." } },
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "A 5-question framework used by CollegeNCourses to help aspirants choose an International Business MBA in 2025-26.",
            step: [
