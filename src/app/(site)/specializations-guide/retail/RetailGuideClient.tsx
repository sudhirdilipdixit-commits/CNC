...
const FAQS: FAQ[] = [
  ...
  { q: "How does CollegeNCourses help me choose?", a: `We match you to programmes based on your target segment (traditional retail, D2C, e-commerce, quick commerce, or consulting), current sales/marketing experience, family-business context, Tier-1 aspirations, budget, and timeline. Free, no call required.` },
    ...
    <>
      ...
      <header className="rt-hero">
        <div className="rt-wrap">
          ...
          <p className="rt-trust">12,000+ aspirants placed since 2019 &nbsp;•&nbsp; 150+ verified universities</p>
      ...
      <section className="rt-cta-band">
        <div className="rt-wrap">
          ...
          <p>Get a free shortlist from our AI Counsellor. We&apos;ll match you to three programmes based on your target segment (traditional retail, D2C, e-commerce, quick commerce, or consulting), current experience, and D2C-founder or consulting aspirations. Free, no call required.</p>
