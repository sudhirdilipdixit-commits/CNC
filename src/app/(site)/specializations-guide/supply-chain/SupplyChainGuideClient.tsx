...
const FAQS: FAQ[] = [
  ...
  { q: "How does CollegeNCourses help me choose?", a: `We match you to programmes based on your target segment (e-commerce, manufacturing, 3PL, retail, or consulting), current operations experience, Tier-1 consulting aspirations, CSCO track ambition, budget, and timeline. Free, no call required.` },
    ...
    <>
      ...
      <section className="sc-cta-band">
        <div className="sc-wrap">
          ...
          <p>Get a free shortlist from our AI Counsellor. We&apos;ll match you to three programmes based on your target segment (e-commerce, manufacturing, 3PL, consulting), current operations experience, Tier-1 aspirations, and budget. Free, no call required.</p>
