      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "A 5-question framework used by CollegeNCourses to help aspirants choose an Operations Management MBA in 2025-26.",
            step: [
