...
const FAQS: FAQ[] = [
  ...
  { q: "How does CollegeNCourses help me choose?", a: `We match you to programmes based on your target segment (manufacturing, services, e-commerce, or consulting), existing certifications (Six Sigma, PMP), Tier-1 consulting aspirations, budget, and timeline. Free, no call required. No paid referral affects our recommendation.` },
  ...
  return (
    <>
      <style>{`
        ...
        .om-h1{font-family:var(--font-serif);font-size:clamp(1.7rem,4vw,2.5rem);line-height:1.2;font-weight:700;text-wrap:balance;margin-bottom:1rem;color:#fff}
      ...
      <section className="om-cta-band">
        <div className="om-wrap">
          ...
          <p>Get a free shortlist from our AI Counsellor. We&apos;ll match you to three programmes based on your target segment, Six Sigma exposure, consulting aspirations, budget, and timeline. Free, no call required.</p>
