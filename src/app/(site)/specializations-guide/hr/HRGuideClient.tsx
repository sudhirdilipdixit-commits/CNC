...
const FAQS: FAQ[] = [
  ...
  { q: "How does CollegeNCourses help me choose an HR MBA?", a: `We match you to programmes based on your target HR role family (HRBP, TA, L&D, Compensation, Analytics, Consulting), consulting aspirations, budget, and timeline. We track HR alumni outcomes from over 25 universities. Free, no call required. No paid referral affects our recommendation.` },
    ...
    <>
      ...
      <section className="hr-cta-band">
        <div className="hr-wrap">
          ...
          <p>Get a free shortlist from our AI Counsellor. We&apos;ll match you to three programmes based on your target HR role family, consulting aspirations, budget, and timeline. Free, no call required.</p>
