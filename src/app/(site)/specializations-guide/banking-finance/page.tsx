        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              ...
              { "@type": "Question", name: "How does CollegeNCourses help me choose a Banking & Finance MBA?", acceptedAnswer: { "@type": "Answer", text: "We match you to programmes based on your current sector employment, target segment, employer sponsorship policy, budget, and timeline. Free, no call required. We also help evaluate whether IIBF certification complements your MBA path." } },
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "A 5-question framework used by CollegeNCourses to help aspirants choose a Banking & Finance MBA in 2025-26.",
            step: [
