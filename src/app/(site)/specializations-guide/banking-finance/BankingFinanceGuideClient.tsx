...
const FAQS: FAQ[] = [
  ...
  { q: "How does CollegeNCourses help me choose?", a: `We match you to programmes based on your current sector employment (bank, NBFC, insurance, fintech, or breaking in), target segment, employer sponsorship policy, budget, and timeline. Free, no call required. We also help evaluate whether IIBF certification complements your MBA path.` },
    ...
    <>
      ...
      <section className="bf-cta-band">
        <div className="bf-wrap">
          ...
          <p>Get a free shortlist from our AI Counsellor. We&apos;ll match you to three programmes based on your sector segment, employer sponsorship policy, budget, and career target. Free, no call required.</p>
