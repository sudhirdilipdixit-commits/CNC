        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              ...
              { "@type": "Question", name: "How does CollegeNCourses help me choose a Digital Marketing MBA?", acceptedAnswer: { "@type": "Answer", text: "We match you to programmes based on your target growth channel, employer type, budget, and timeline. We shortlist three programmes from UGC-DEB approved options only. Free, no call required. No paid rankings." } },
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "A 5-question framework used by CollegeNCourses to help aspirants choose a Digital Marketing MBA in 2025-26.",
            step: [
