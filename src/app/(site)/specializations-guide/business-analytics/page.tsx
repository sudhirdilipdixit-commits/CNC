        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              ...
              { "@type": "Question", name: "How does CollegeNCourses help me choose?", acceptedAnswer: { "@type": "Answer", text: "We match you to programmes based on your target industry, tool comfort, career goal, budget, and Tier-1 consulting aspiration. Free, no call required. Shortlist three programmes from UGC-DEB approved options only." } },
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "A 5-question framework used by CollegeNCourses to help aspirants choose a Business Analytics MBA in 2025-26.",
            step: [
