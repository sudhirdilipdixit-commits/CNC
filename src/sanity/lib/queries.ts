...
export const landingPageQuery = groq`*[_type == "landingPage" && slug.current == $slug][0]{
  ...
  "courseItems": courseItems[]->{
    ...
    duration, fees, eligibility, badge, isFeatured,
  },
  "universityItems": universityItems[]->{
    ...
    "universityLogoAlt": universityLogo.alt,
    "universityLogoTitle": universityLogo.title,
    duration, approvedBy, fees, eligibility, badge, isFeatured,
  },
  "faqs": faqs[]{
...
export const landingPagesQuery = groq`*[_type == "landingPages" && slug.current == $slug][0]{
  ...
  scrollingNotification { show, text, speed },
  hero {
  ...
  heroOption3 {
    show, eyebrow, headline, subheadline, subheadlineAlign, showEnquiryForm, primaryCtaLabel, secondaryCtaLabel,
    "backgroundColor": backgroundColor.hex,
    "buttonColor": buttonColor.hex,
    "fontColor": fontColor.hex,
  },
